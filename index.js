...
/* tire esse "${OwnerNumber}" e coloque seu número
* exemplo: [`559481417512@s.whatsapp.net`] */
...
const {
  color, 
  bgcolor
} = require('./base de dados/lib/color');

/********** LIMIT TTT **********/
const { 
  addLimit, 
  getLimit 
} = require('./base de dados/lib/limit.js')
...
var {
  ...
  checkATMuser,
  log
} = require('./base de dados/lib/functions');
...
const {
  ...
  leveltab,
  dellprem
 } = require('./base de dados/lib/leveling.js')
...
const { 
  ...
  getTTTties, 
  getTTTpoints
} = require('./base de dados/lib/tictactoe.js')
...
fs.existsSync('./qr.json') && lolizita.loadAuthInfo('./qr.json')
...
lolizita.sendMessage(`${OwnerNumber}@s.whatsapp.net`, `
╭ ⋟ Bot conectado aqui. 
╰━━━━━── • ──━━━━━
        「${NomeDoBot}」`, MessageType.text)
  await lolizita.connect({timeoutMs: 10*1000})
fs.writeFileSync('./qr.json', JSON.stringify(lolizita.base64EncodedAuthInfo(), null, '\t'))
...
lolizita.on('group-participants-update', async (anu) => {
  ...
  lolizita.sendMessage(mdata.id, 'Números fake não são permitidos nesse grupo️️', MessageType.text)							
...
teks = `Olá @${num.split('@')[0]}\nSeja bem vindo(a) ao grupo: ${mdata.subject}`
  ...
  lolizita.sendMessage(mdata.id, bufff, MessageType.image, {caption: teks, thumbnail:null, contextInfo: {"mentionedJid": [num]}})
...
teks = `O integrante @${num.split('@')[0]} saiu do grupo... bye bye👋`
  ...
  lolizita.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, thumbnail:null, contextInfo: {"mentionedJid": [num]}})
  }
  } catch (e) {
...
/********** FUCTION BLOCKLIST **********/
lolizita.on('blocklist-update', async (chat) => {
  for (i of chat.added){
...
lolizita.on('CB:action,,call', async json => {
  ...
  lolizita.sendMessage(callerId, `${emoji_bot} Ligações = block`, MessageType.text)
  setTimeout(async() => {
...
/************** CONST DE STRING ************/
  ...
  var totalchat = await lolizita.chats.all()
...
/************** LINGUAGEM GRUPO ************/
  ...
  const sender = mek.key.fromMe ? lolizita.user.jid : mek.key.remoteJid.endsWith('@g.us') ? mek.participant : mek.key.remoteJid
...
/************** PUSHNAME (NOME) ************/
  let pushname = lolizita.contacts[sender] != undefined ? lolizita.contacts[sender].vname || lolizita.contacts[sender].notify: undefined
  const conts = mek.key.fromMe ? lolizita.user.jid : lolizita.contacts[sender] || { notify: jid.replace(/@.+/, '') }
...
const sendStickerFromUrl = async(to, url) => {
  ...
  lolizita.sendMessage(to, media, MessageType.sticker,{sendEphemeral: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: mek})
...
lolizita.sendMessage(from, hasil, type, options).catch(e => {
fetch(link).then((hasil) => {
lolizita.sendMessage(from, hasil, type, options).catch(e => {
lolizita.sendMessage(from, { url : link }, type, options).catch(e => {
...
/********** ENVIAR MSG **********/
const enviar = (teks) => {
lolizita.sendMessage(from, teks, text,  {quoted: mek, contextInfo: {"mentionedJid": [sender], forwardingScore: 1000, isForwarded: true}})
}
...
(id == null || id == undefined || id == false) ? lolizita.sendMessage(from, teks.trim(), extendedText, {contextInfo: {"mentionedJid": memberr}}) : lolizita.sendMessage(from, teks.trim(), extendedText, {quoted: mek, contextInfo: {"mentionedJid": memberr}})
}
...
/********** MENSAGENS DO BOT **********/
var replys = [`${emoji_bot} Okay oni chan, espere, estou processando os dados...`, `⏳Aguarde alguns instantes...⏳\n\nCaso não funcione, use o comando novamente.`, `Espere... Caso não funcione, use o comando novamente.`, `Calmae macaco, estou fazendo...`, `Por enquanto que estou processando os dados adquirido...\n\nTopa ir na esquina da praça comer uma pizza com suco🍕`, `Aguarde... Por enquanto vou tomar um café! ☕`, `Por usa o comando: "${comando}"... Você irá perder ${randomPerda} em xp`, `🥳 Parabéns...🥳 Você ganhou: ${randomTTTXP}... Em xp!!`]
...
let anu = await lolizita.groupMetadata(from)
let members = anu.participants
let ane = []
for (let i of members){
ane.push(i.jid)
}
lolizita.sendMessage(from, text, 'extendedTextMessage', {quoted: mek, contextInfo: {"mentionedJid": ane}})
}  
...
lolizita.sendMessage(from, result, audio, {mimetype: 'audio/mp4', ptt: true, quoted: mek})
...
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: `${kapai}`})
return 
}
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: help(p, hr, pushname, prema, checATM, useLevel, useXp, requireXp, patt, bateria, chatss, antilink_by_tobi, welcome_by_tobi, levelingon_by_tobi, antifaker_by_tobi, selfchat_by_tobi)})
break
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: grupo_by_tobi})
break

case 'dono':
lolizita.sendMessage(from, '『❗』Nᴜᴍᴇʀᴏ do Mᴇᴜ Cʀɪᴀᴅᴏʀ foi Eɴᴠɪᴀᴅᴏ no seu ᴘʀɪᴠᴀᴅᴏ',MessageType.text, { quoted: mek} )
lolizita.sendMessage(sender, 'Esᴛᴇ ᴇ́ ᴍᴇᴜ ᴄʀɪᴀᴅᴏʀ [(>_<)] Cᴀsᴏ ᴛᴇɴʜᴀ ᴀʟɢᴜᴍᴀ ᴅᴜᴠɪᴅᴀ ғᴀʟᴇ ᴄᴏᴍ ᴇʟᴇ',MessageType.text, { quoted: mek} )
lolizita.sendMessage(sender, {displayname: "Jeff", vcard: vcard}, MessageType.contact, {quoted: mek})
break
...
await lolizita.groupSettingChange(from, GroupSettingChange.messageSend, true)
...
lolizita.sendMessage(from, `${emoji_bot} Nome do grupo alterado`, text, {quoted: mek})
break
...
lolizita.sendMessage(from, `${emoji_bot} Descrição do grupo alterada`, text, {quoted: mek})
break
...
lolizita.sendMessage(from, buffer, image, {quoted: mek, thumbnail:null, caption: `*NOME* : ${groupName}\n*MEMBRO* : ${groupMembers.length}\n*ADMIN* : ${groupAdmins.length}\n*DESCRIÇÃO*:\n${groupDesc}`})
...
const teste65 = await lolizita.getStatus(teste64 , MessageType.text)
try {
ppimg = await lolizita.getProfilePicture(`${sender.split('@')[0]}@c.us`)
} catch {
ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
pf = 
...
lolizita.sendMessage(from, its, image, {quoted: mek, thumbnail:null, caption: pf, contextInfo: {mentionedJid: [sender]}})
}
break
...
linkgc = await lolizita.groupInviteCode(from)
lolizita.sendMessage(senderr, 'https://chat.whatsapp.com/'+linkgc, MessageType.text)
}
break
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: figurinhas_by_tobi})
break
...
lolizita.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
fs.unlinkSync(media)	
fs.unlinkSync(ran)	
 })
 })
...
fs.unlinkSync(ranp)
if (err) return enviar(linguagem.stick())
exec(`webpmux -set exif ${addMetadata(`${SeuNome}`)} ${ranw} -o ${ranw}`, async (error) => {
if (error) return enviar(linguagem.stick())
lolizita.sendMessage(from, fs.readFileSync(ranw), sticker, {quoted: mek})
fs.unlinkSync(ranw)
})
})
})
...
lolizita.sendMessage(from, buffer, image, {quoted: mek, caption: '🐤'})
fs.unlinkSync(ran)
})
break
...
lolizita.sendMessage(from, mp4, MessageType.video, {mimetype: 'video/gif', filename: `stick.gif`, quoted: mek, caption: '🐤'})
...
enviar(mess.espere)
owgi = await lolizita.downloadAndSaveMediaMessage(ger)
...
lolizita.sendMessage(from, nobg, sticker, {quoted: mek})
fs.unlinkSync(rano)
})
} else {
...
lolizita.sendMessage(from, attp2, sticker, {quoted: mek})
break
...
lolizita.sendMessage(from, send, sticker, {quoted: mek})
break	     
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: plars_by_tobi})
break
...
lolizita.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', quoted: mek})
...
lolizita.sendMessage(from, buffer, image, {quoted: mek, caption: `${play_4.result.title}`})
lolizita.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', quoted: mek})
.catch(() => enviar(`[📍] Cᴏᴍᴀɴᴅᴏ : *${comando}*\n[❗] Mᴜsɪᴄᴀ : *${q}*\n[‼️] Sɪᴛᴜᴀᴄ̧ᴀ̃ᴏ : *Erro!* \n*『Tᴇɴᴛᴇ ᴜsᴀʀ ᴏᴜᴛʀᴏ ᴘʟᴀʏ』*`))
break
...
lolizita.sendMessage(from, buffer, image, {quoted: mek})					
msc = await getBuffer(anu.result.url)				
lolizita.sendMessage(from, msc, audio, {mimetype: 'audio/mp4', filename: `${q}`, quoted: mek })
.catch(() => enviar(`[📍] Cᴏᴍᴀɴᴅᴏ : *${comando}*\n[❗] Mᴜsɪᴄᴀ : *${q}*\n[‼️] Sɪᴛᴜᴀᴄ̧ᴀ̃ᴏ : *Erro!* \n*『Tᴇɴᴛᴇ ᴜsᴀʀ ᴏᴜᴛʀᴏ ᴘʟᴀʏ』*`))
break
...
lolizita.sendMessage(from, buffer, image, {quoted: mek, thumbnail:null, caption: `${testekkzu}`})		
lolizita.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', quoted: mek})
.catch(() => enviar(`[📍] Cᴏᴍᴀɴᴅᴏ : *${comando}*\n[❗] Mᴜsɪᴄᴀ : *${q}*\n[‼️] Sɪᴛᴜᴀᴄ̧ᴀ̃ᴏ : *Erro!* \n*『Tᴇɴᴛᴇ ᴜsᴀʀ ᴏᴜᴛʀᴏ ᴘʟᴀʏ』*`))
break
...
buffer = fs.readFileSync(ran)
lolizita.sendMessage(from, buffer, audio, {mimetype: 'audio/mp4', ptt:true, quoted: mek})
fs.unlinkSync(ran)
})
break
...
return await lolizita.sendMessage(from, 'Error!', MessageType.text, dload)
}
aramat = aramas.all 
...
ytresult += `◩ *${NomeDoBot}*`
await lolizita.sendMessage(from, tbuff, image, {thumbnail: fs.readFileSync('./base de dados/lib/logo.jpeg'),quoted: mek, caption: ytresult})
break

case 'sombrio': 
encmmedia = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
mehdia = await lolizita.downloadAndSaveMediaMessage(encmmedia)
ran = getRandom('.mp3')
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: nuvem_by_tobi})
break
...
lolizita.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": setiker } })
break
...
lolizita.sendMessage(from, result, sticker, {quoted: mek, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
} catch {
...
lolizita.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": audionye } })
break
...
lolizita.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: mek, ptt: true })
} catch {
enviar('Pacote não registrado')
}
break
...
lolizita.sendMessage(from, teks.trim(), extendedText, { quoted: mek, thumbnail:null, contextInfo: { "mentionedJid": imagenye } })
break
...
lolizita.sendMessage(from, buffer, image, { quoted: mek, caption: `Resultado do banco de dados : ${namastc}.jpeg` })
} catch {
...
lolizita.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": videonye } })
break
...
lolizita.sendMessage(from, buffer, video, { mimetype: 'video/mp4', quoted: mek })
} catch {
enviar('Pacote não registrado')
}
break
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: jogos_by_tobi})
break
...
const arroz = lolizita.contacts[mentioned] != undefined ? lolizita.contacts[mentioned].vname || lolizita.contacts[mentioned].notify: undefined
nome = `${arroz}`
lolizita.sendMessage(from, nome, text, {quoted: mek})	
break
...
lolizita.sendMessage(from, dador, sticker, {quoted: mek})
break
...
lolizita.sendMessage(from, hasil, text, {quoted: mek, contextInfo: {mentionedJid: [sender]}})
break
...
lolizita.sendMessage(from, leaderboardlvl, text, {quoted: mek})
} catch (err) {
console.error(err)
...
lolizita.sendMessage(from, `『❗』Parabens *${pushname}* Você perdeu.\n\n➣  PUNIÇÃO: +${randomTTTXP} XP 🔮`, text)
} else {
...
case 'ttthelp': 
lolizita.sendMessage(from, ttthelp(p), text, {quoted:mek})
break
...
console.log(err)
await lolizita.sendMessage(from, `Humm, é necessário que no mínimo 3 pessoas tenham jogado...`, text, {quoted: mek})
}
break
...
lolizita.sendMessage(from, slott, text, {quoted: mek})
break
...
setTimeout( () => {
lolizita.sendMessage(from, figb, sticker, {quoted: mek})
}, 2100)
}
setTimeout( () => {
lolizita.sendMessage(from, morte, text, {quoted: mek})
}, 2300)
break
...
lolizita.sendMessage(from, cararoa, sticker, {quoted: mek})
break
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: animes_by_tobi})
break
...
lolizita.sendMessage(senderr, hentanime, image, {quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(sender, buf, MessageType.image, {quoted: mek, thumbnail:null})
})
})
} catch (e) {
...
lolizita.sendMessage(senderr, buffer, image, {caption: 'Baum né?', quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(senderr, buffer, image, {caption: `${comando}, certo?`, quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(senderr, buffer, image, { quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(from, img, image, { quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(from, hentanime, image, {quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(from, lolizinha, image, {quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(from, shota, image, {quoted: mek, thumbnail:null})
break
...
lolizita.sendMessage(from, buffer, image, {caption: `${comando}, certo?`, quoted: mek, thumbnail:null})
break
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: dono_by_tobi})
break
...
for (let _ of tobis) {
lolizita.sendMessage(_.jid, buff, image, {caption: `╭━━━━━── • ──━━━━━\n┃⋟ 𝚃ʀᴀɴsᴍɪssᴀ̃ᴏ ᴅᴇ 𝙰ᴠɪsᴏ╰━━━━━── • ──━━━━━\n╭━━━━━── • ──━━━━━\n╰ ⋟ 𝚃ʀᴀɴsᴍɪssᴀ̃ᴏ:\n${q}`})
}
enviar('Transmissão enviada com sucesso')
} else {*/
...
lolizita.sendMessage(from, `Usuário bloqueado`, text, {quoted: mek})
break
...
lolizita.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": palavra } })
break

case 'mystat':
 if (!isOwner) return enviar('Este comando e so pro meu criador')
var groups = lolizita.chats.array.filter(v => v.jid.endsWith('g.us'))
var privat = lolizita.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
var ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
uptime = process.uptime();
timestamp = speed();
totalChat = await lolizita.chats.all()
...
┃│⪧ 𝚅𝖾𝗋𝗌𝖺̃𝗈 𝖽𝗈 𝖼𝖾𝗅𝗎𝗅𝖺𝗋: ${lolizita.user.phone.os_version}
┃│⪧ 𝚃𝖾𝗆𝗉𝗈 𝖽𝖾 𝖺𝗍𝗂𝗏𝗂𝖽𝖺𝖽𝖾: ${temporizado(os.uptime())}
┃│⪧ 𝚅𝖾𝗋𝗌𝖺̃𝗈 𝖽𝗈 𝗐𝗁𝖺𝗍𝗌𝖺𝗉𝗉: ${lolizita.user.phone.wa_version}
┃│⪧ 𝙼𝗈𝖽𝖾𝗅𝗈 𝖽𝗈 𝖽𝗂𝗌𝗉𝗈𝗌𝗂𝗍𝗂𝗏𝗈: ${lolizita.user.phone.device_model}
┃└══════════════⊷
└════════════════⊷`
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: `${teks}`})
break
...
filePath = await lolizita.downloadAndSaveMediaMessage(enmedia, filename = getRandom())
var value = args.join(" ")
var group = await lolizita.groupMetadata(from)
var member = group['participants']
var mem = []
...
filePath = await lolizita.downloadAndSaveMediaMessage(ncmedia, filename = getRandom())
var value = args.join(" ")
var group = await lolizita.groupMetadata(from)
var member = group['participants']
var mem = []
...
'jpegThumbnail': fs.readFileSync('./base de dados/lib/logo.jpeg')
}
}
}
})
...
lolizita.sendMessage(from, teks.trim(), extendedText, {quoted: mek, contextInfo: {"mentionedJid": blocked}})
break
...
exec(npm, (err, stdout) => {
if(err) return lolizita.sendMessage(from, "Erro", text, {quoted: mek})
if (stdout) {
lolizita.sendMessage(from, stdout, text, {quoted: mek})
} 
})
break
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: logos_by_tobi})
break
...
lolizita.sendMessage(from, buffer, image, {caption: `Pronto...`, quoted: mek, thumbnail:null})
break
...
case 'report': //info
const bug = `${q}`
 if (args.length > 300) return lolizita.sendMessage(from, 'Máximo 300 caracteres', msgType.text, {quoted: mek})
var nomor = mek.participant
teks1 = `╭ ⋟ 𝖲𝗎𝗀𝖾𝗌𝗍𝖺̃𝗈 + 𝖱𝖾𝗉𝗈𝗋𝗍𝖾\n├ ⋟ 𝖣𝖾: ${pushname}\n├ ⋟ 𝖭𝗎𝗆𝖾𝗋𝗈: @${sender.split("@s.whatsapp.net")[0]}\n╰━━━━━── • ──━━━━━\n ⋟ 𝖲𝗎𝗀𝖾𝗌𝗍𝖺̃𝗈:\n${bug}`
var options = {text: teks1, contextInfo: {mentionedJid: [sender]},}
lolizita.sendMessage(`${OwnerNumber}@s.whatsapp.net`, options, text, {quoted: mek})
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: premiun_by_tobi})
break
...
lolizita.sendMessage(from, dddlist, text, {quoted: mek})	
break
...
lolizita.sendMessage(from, buffer, image, {quoted: mek, thumbnail:null, caption: `Pesquisa sobre: ${q}`})
break
...
╰══════「★」═════⊷`
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: `${by_tobi_thiago}`})
break
...
lolizita_7 = `${ini_txt}───────────────\n\n`
lolizita.sendMessage(from, lolizita_7, text, {quoted: mek})
break
...
lolizita.sendMessage(from, buffer, image, { quoted: mek, thumbnail:null, caption: `${play_store}`})
break
...
🔋 Tipo da bateria: ${anu.merek_batre}`
 wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: `${busca_celular}`})
break
...
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: `${item}`})
break
...
if (err) return console.log(err);
lolizita.sendMessage(from, fs.readFileSync(exifst), sticker, {quoted: mek})
...
╰══════「★」═════⊷`
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
lolizita.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: `${bya_tobi_thiago}`})
break 
...
e = String(e)
console.log('Error : %s', color(e, 'red'))
lolizita.sendMessage(`${OwnerNumber}@s.whatsapp.net`, `Error: ${e}`, MessageType.text) 
}
})
}
starts()
